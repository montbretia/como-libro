...
saber-cómo es un individuo. Sin embargo, es importante examinar si es posible
...
En este capítulo vamos a explorar esto desde una perspectiva general, primero
(#ref(<groups>)), considerando primero el problema general de que las entidades
colectivas puedan tener o al menos ser atribuibles con estados epistémicos, y
luego el caso específico del saber-cómo, y después desde la perspectiva de dos
casos de estudio interesantes: el del saber-cómo científico
(#ref(<sci-know-how>)) y el del saber-cómo social (#ref(<social-know-how>)).
...
https://plato.stanford.edu/entries/epistemology-social/ Hay varios textos de
referencia útiles. Uno es el _Routledge Handbook of Social Epistemology_
(#cite(<Fricker2021>, form: "year")), editado por Miranda Fricker, Peter Graham,
