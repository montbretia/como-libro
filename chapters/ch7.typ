...
¿Qué tiene de misterioso eso? Algunos filósofos han propuesto que el
acoplamiento que tenemos con el mundo mediante las herramientas que usamos es
metafísicamente significativo, y han propuesto que para explicar el uso de
herramientas tenemos que cambiar nuestra comprensión de la naturaleza de la
mente; tendríamos, según esta idea, que dejar de pensar que el sitio del saber
cómo termina en los límites de nuestro cuerpo, sino que se extiende al entorno
mediante las herramientas que usamos. Esto se ha llamado la _hipótesis de
...
podríamos llamar _Cartesianismo_), o bien como el cuerpo de un organismo
viviente. En ambos casos, los procesos mentales están asociados a procesos que
ocurren dentro de los confines del cuerpo, sin participación del entorno. Las
teorías clásicas de la mente están comprometidas con la siguiente tesis acerca
de la naturaleza de la mente:

/ Constitución: La mente depende para su constitución solo de hechos
  intracraniales.
...
plausible que el señor Anderson tenga razones para creer lo que cree, estas
razones no son suficientes para decir que tiene conocimiento, porque sus
