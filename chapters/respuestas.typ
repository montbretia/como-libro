...
+ No<q2_3> creo que los contraejemplos de Gettier sean decisivos contra el
  ...
  empleamos un concepto de justificación que no requiere factividad, de
...
+ La lectura no puede ser una fuente básica de conocimiento, porque
  ...
  texto como este no sería viable si esto no fuera posible).

+ Sería necesario descubrir que el saber cómo no puede obtenerse de
  alguna de las formas en que se puede obtener el conocimiento
  proposicional. En efecto, como veremos, es posible defender esta idea.
  Sin embargo, es menos plausible cuando consideramos la posibilidad de
  que obtengamos saber cómo mediante las fuentes básicas del
...
+ Ambas posturas pueden defenderse (así como la teoría de que los
  ...
  véase Magidor (2013) para más detalles). Cabe hacer la siguiente
  observación lógica para apreciar el efecto de tomar una u otra
  posición. Si un error de categoría es absurdo, también lo es su
  negación. Pero si un error de categoría es falso, su negación es
  verdadera. Supón que la doctrina oficial que Ryle ataca es, como él
  dice, un error de categoría. Uno podría suponer que es falsa porque
  las personas no son compuestos de una mente y un cuerpo (contra el
  dualismo). Pero si la doctrina es absurda, también es absurdo decir
